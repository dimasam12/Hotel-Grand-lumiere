...
@media (max-width: 1024px) {
    .page-wrapper { padding: 90px 16px 48px; }
        ...
        <table id="bookingsTable">
            ...
            ?>
                <tr
                    ...
                    data-id="<?= intval($b['id']) ?>"
                >
                    <td data-label="Kode" style="font-family:monospace;font-size:13px">
                        <?= htmlspecialchars($b['kode_booking'] ?? '—') ?>
                    </td>
                    <td data-label="Kamar"><?= htmlspecialchars($b['tipe_kamar'] ?? '—') ?></td>
                    <td data-label="No. Kamar" class="nomor-kamar-cell">
                    ...
                    <td data-label="Check In"><?= $b['check_in']  ? date('d M Y', strtotime($b['check_in']))  : '—' ?></td>
